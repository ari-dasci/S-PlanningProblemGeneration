...
title_sk = "Sokoban"
X_sk = ['4x4','5x5','5x6','6x6','6x7'] # We don't use 7x7 due to time/memory outs (problems generated by NeSIG are too difficult)
ad_hoc_Y_sk = [12.43,1202,109054,620018,585550]
NeSIG_Y_sk = [[209.35999999999999,236499,10381782,10602888,31859137],
              [207.94333333333336,285352,11061516,12954086,32311481],
              [207.92,118489,1392969,5106929,30682125],
              [148.24333333333334,226739,9002458,12092686,42751749],
              [325.69,350635,2182325,13627397,9326338]]
# python collect_and_summarize_results.py ../../experiments ../../data/instance_generators --filter-query "domain=sokoban,init_policy=adhoc,goal_policy=adhoc" --agg-fields planner,Mean_difficulty --group-fields experiment_id,domain,init_policy,goal_policy,seed,size > output.txt
...
filename = "plot_astar_lg_new.jpg"
title = "A* - Logistics"
X = [10,15,20,25,30]
ad_hoc_Y = astar_adhoc_lg
NeSIG_Y = astar_nesig_lg
