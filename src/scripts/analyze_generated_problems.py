...
>>> Examples of use:
    - NeSIG (experiment identified by parameters):
        python analyze_generated_problems.py --domain blocksworld --init-policy PPO --goal-policy PPO --seed 0 --max-init-actions-test 15 --max-goal-actions-test 75
    - NeSIG (experiment identified by experiment_id):
        python analyze_generated_problems.py --experiment-id 0ae0837594 --max-init-actions-test 15 --max-goal-actions-test 75
    - adhoc:
        python analyze_generated_problems.py --experiment-id 8-10_3-10__1_100_1.0 --domain blocksworld
"""
...
def parse_arguments():
    ...
    parser.add_argument('--init-policy', type=str, default=None, help='The init-policy of the experiment: PPO, random or adhoc')
    parser.add_argument('--goal-policy', type=str, default=None, help='The goal-policy of the experiment: PPO, random or adhoc')
    parser.add_argument('--seed', type=int, default=None, help='The seed of the experiment')
    parser.add_argument('--max-init-actions-test', type=int, required=True, help='Used to differentiate between the different test problem sizes of the same experiment')
    parser.add_argument('--max-goal-actions-test', type=int, required=True, help='Used to differentiate between the different test problem sizes of the same experiment')
