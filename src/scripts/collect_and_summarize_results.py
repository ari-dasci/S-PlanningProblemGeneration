...
python collect_and_summarize_results.py ../../experiments ../../data/instance_generators --filter-query "domain=blocksworld,init_policy=PPO,goal_policy=PPO" --agg-fields planner,Mean_difficulty --group-fields experiment_id,domain,init_policy,goal_policy,seed,size
