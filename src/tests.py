...
def test_load_models_and_generate_problems_logistics():
	...
	# Create the generator and load the trained models
	its=7500
	init_policy_path = f"saved_models/both_policies_5/init_policy_its-{its}.ckpt"
	goal_policy_path = f"saved_models/both_policies_5/goal_policy_its-{its}.ckpt"
	...
	generator = Generator(parser, planner, goal_predicates, consistency_validator=consistency_validator,
							allowed_virtual_objects=virtual_objects,
							device='cpu', max_objs_cache_reduce_masks=25,
...
def test_load_models_and_resume_training_logistics():
	...
	# Create the generator and load the trained models
	curr_it = 5650 # It of the loaded model, used to resume training
	init_policy_path = "saved_models/both_policies_4/init_policy_its-{}.ckpt".format(curr_it)
	goal_policy_path = "saved_models/both_policies_4/goal_policy_its-{}.ckpt".format(curr_it)
...
def test_load_models_and_generate_problems_blocksworld():
	...
	generator = Generator(parser, planner, goal_predicates, consistency_validator=consistency_validator,
									allowed_virtual_objects=virtual_objects,
									device='cpu', max_objs_cache_reduce_masks=15,
...
def test_load_models_and_resume_training_sokoban():
	from problem_generation.controller.generator import Generator
	from problem_generation.environment.planner import Planner
	from problem_generation.environment.consistency_validator_sokoban import ConsistencyValidatorSokoban
	from problem_generation.environment.relational_state import RelationalState
