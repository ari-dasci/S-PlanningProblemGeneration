...
from pddl_features_extractor import SimplePDDLFeatureExtractor
extractor = SimplePDDLFeatureExtractor()
features_dict = extractor.extract('logistics-domain.pddl', 'logistics-problem.pddl')[0]
"""

class SimplePDDLFeatureExtractor(FeatureExtractor):
    # def __init__(self, args):
    def __init__(self):
        super(SimplePDDLFeatureExtractor, self).__init__()

        self.extractor_name = "simple-pddl"
        # self.simple_pddl_extended_features = args.simple_pddl_extended_features
        self.simple_pddl_extended_features = True
